...
with open("sheroes_translate.txt", "w", encoding="utf-8") as file:
    ...
    for id_number in abcd_id_list:
        ...
        if to_lang not in languages:
            ...
            # print('Name: ', name_translated.text)

            description_translated = translator.translate(desc, dest=to_lang)
            # print('Description: ', description_translated.text)

            did_you_know_translated = translator.translate(dyk, dest=to_lang)
            # print('Did You Know: ', did_you_know_translated.text)

            serial_num += 1

            # Write the translated information to the file
            ...
            file.write("\n")  # Add a newline to separate each set of information
