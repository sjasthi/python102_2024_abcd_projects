...
abcd_id_list = [26,27,28,29,30,31]
...
# python_mask = np.array(Image.open(r'C:\Users\ugant\Pictures\Screenshots\Screenshot 2024-04-03 190905.png'))

# Using the WordCloud function to generate the wordcloud and giving its parameters
